...
<section id="projects">
	...
	<p class="projects-paragraph">
		If you want to know more, please feel free to go through my resume.
	</p>
	<a href={cv} download class="install-button">Resume</a>
</section>
